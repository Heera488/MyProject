...
(function () {
    ...
    function eb(k) {
        if (k._menuButton) k.exportEnabled ? Ia(k._menuButton) : sa(k._menuButton);
            ...
            V(
                ...
                function () {
                    m ||
                        (na(k, k._menuButton, { backgroundColor: k.toolbar.backgroundColorOnHover, color: k.toolbar.fontColorOnHover }),
                            0 >= navigator.userAgent.search("MSIE") && na(k, k._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                },
                k.allDOMEventHandlers,
                !0
            );
            V(
                ...
                function () {
                    m ||
                        (na(k, k._menuButton, { backgroundColor: k.toolbar.backgroundColor, color: k.toolbar.fontColor }),
    ...
    function ta(k, m, w) {
        m.getAttribute("state") ||
            ((m.style.backgroundColor = k.toolbar.backgroundColor), (m.style.color = k.toolbar.fontColor), (m.style.border = "none"), na(k, m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        m.getAttribute("state") !== w &&
            (m.setAttribute("state", w),
                m.setAttribute("type", "button"),
                na(k, m, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
                m.setAttribute("title", k._cultureInfo[w + "Text"]),
                (m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + hb[w].image + "' alt='" + k._cultureInfo[w + "Text"] + "' />"));
    }
    function Ia() {
    ...
    function W(k, m, w, u, y) {
        ...
        this.theme && s(this.parent) && s(m) && s(u)
            ? (k = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
            : this.parent &&
            this.parent.themeOptions &&
            this.parent.themeOptions[m] &&
            (null === u ? (k = this.parent.themeOptions[m]) : 0 < this.parent.themeOptions[m].length && ((u = Math.min(this.parent.themeOptions[m].length - 1, u)), (k = this.parent.themeOptions[m][u])));
        this.themeOptions = k;
    ...
    (function () {
        J.fSDec = function (k) {
            for (var m = "", w = 0; w < k.length; w++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(w));
            return m;
        };
        J.obj = { trVs: "Ush`m!Wdsrhno", fntStr: "qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg", txtBl: "udyuC`rdmhod", fnt: "gnou", fSy: "ghmmRuxmd", fTx: "ghmmUdyu", grClr: "fsdx", cntx: "buy", tp: "unq" };
    ...
    var db = (function () {
        ...
        Y = function (k) {
            for (var m = "", s = 0; s < k.length; s++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(s));
            return m;
        },
        $a =
            window &&
    ...
    W.prototype.setOptions = function (k, m) {
        if (oa[this._defaultsKey]) {
            var s = oa[this._defaultsKey],
                u;
            for (u in s) "publicProperties" !== u && s.hasOwnProperty(u) && (this[u] = k && u in k ? k[u] : m && u in m ? m[u] : s[u]);
    ...
    W.prototype.updateOption = function (k) {
        ...
        this.theme && s(this.parent) && s(E) && s(J)
            ...
            (null === J ? (u = this.parent.themeOptions[E]) : 0 < this.parent.themeOptions[E].length && ((u = Math.min(this.parent.themeOptions[E].length - 1, J)), (u = this.parent.themeOptions[E][u])));
        this.themeOptions = u;
    ...
    W.prototype.addEventListener = function (k, m, s) {
        k && m && ((this._eventListeners[k] = this._eventListeners[k] || []), this._eventListeners[k].push({ context: s || this, eventHandler: m }));
    };
    ...
    W.prototype.dispatchEvent = function (k, m, s) {
        if (k && this._eventListeners[k]) {
            m = m || {};
            for (var u = this._eventListeners[k], y = 0; y < u.length; y++) u[y].eventHandler.call(u[y].context, m);
        }
                ...
                (E = this._wrappedText.lines[s]),
                    "right" === this.horizontalAlign
                        ...
                        : "left" === this.horizontalAlign
                            ? (u = this.leftPadding)
                            : "center" === this.horizontalAlign && (u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding),
    ...
    wa.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)), (J = 0.5 * m.height - this.margin - 2), (E = 0))
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((y = m.y1 + 2), (I = "top")) : "bottom" === this.verticalAlign && ((y = m.y2 - 2 - M.height), (I = "bottom")),
                ...
                : "center" === this.verticalAlign &&
                ("left" === this.horizontalAlign
                    ? ((u = m.x1 + 2), (y = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2)), (E = -90), (I = "left"), (this.width = M.height), (this.height = M.width))
                    : "right" === this.horizontalAlign
                        ? ((u = m.x2 - 2), (y = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2)), (E = 90), (I = "right"), (this.width = M.height), (this.height = M.width))
                        : "center" === this.horizontalAlign && ((y = k.y1 + (k.height / 2 - M.height / 2)), (u = k.x1 + (k.width / 2 - M.width / 2)), (I = "center"), (this.width = M.width), (this.height = M.height)),
                    (N = "center"));
            J.x = u;
            J.y = y;
            J.angle = E;
    ...
    y = Ma.Chart = (function () {
        ...
        function m(a, d, c) {
            d = d || {};
            s(c)
                ? ((this.predefinedThemes = Za), (this.optionsName = this.parent = this.index = null))
        ...
        function y(a, d, c, b, e, f, p, l, B, h) {
            ...
            a.beginPath();
            B && 0 < l.thickness
                ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - r), a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - r))
                : 0 < l.thickness && (a.moveTo(Math.round((d + b) / 2) - r, c + p.thickness / 2), a.lineTo(Math.round((d + b) / 2) - r, e - p.thickness / 2));
            a.stroke();
        ...
        m.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    V(
                        ...
                        function () {
                            d
                                ? (d = !1)
                                : (na(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                                    0 >= navigator.userAgent.search("MSIE") && na(a, a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                    V(
                        ...
                        function () {
                            d ||
                                (na(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                    0 >= navigator.userAgent.search("MSIE") && na(a, a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                }
                this._resetButton ||
                    ((d = !1),
                        ...
                        V(
                            ...
                            function () {
                                ...
                                a.zoomEnabled || a.panEnabled
                                    ? ((a.zoomEnabled = !0), (a.panEnabled = !1), ta(a, a._zoomButton, "pan"), (a._defaultCursor = "default"), (a.overlaidCanvas.style.cursor = a._defaultCursor))
                        ...
                        V(
                            ...
                            function () {
                                d ||
                                    (na(a, a._resetButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.hoverFfontColorOnHoverontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                        ...
                        V(
                            ...
                            function () {
                                d ||
                                    (na(a, a._resetButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                        0 >= navigator.userAgent.search("MSIE") && na(a, a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                            },
                            this.allDOMEventHandlers
                        ),
                ...
                this.zoomEnabled ||
                    this.panEnabled ||
                    (this._zoomButton
                        ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? ((this.panEnabled = !0), (this.zoomEnabled = !1)) : ((this.zoomEnabled = !0), (this.panEnabled = !1)), Ia(a._zoomButton, a._resetButton))
                        : ((this.zoomEnabled = !0), (this.panEnabled = !1)));
            } else this.panEnabled = this.zoomEnabled = !1;
            eb(this);
            "none" !== this._toolBar.style.display &&
                this._zoomButton &&
                (this.panEnabled ? ta(a, a._zoomButton, "zoom") : ta(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && ta(a, a._resetButton, "reset"));
        ...
        m.prototype.setLayout = function () {
            ...
            c
                ? (Ia(this._zoomButton, this._resetButton),
                    ...
                    (this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor),
                    (this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor))
                : (sa(this._zoomButton, this._resetButton), (this._toolBar.style.border = this.toolbar.borderThickness + "px solid transparent"), this.options.zoomEnabled && ((this.zoomEnabled = !0), (this.panEnabled = !1)));
            cb(this);
            this._processData();
            ...
            this.subtitles = [];
            if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) (c = new Fa(this, this.options.subtitles[d], d)), this.subtitles.push(c), c.dockInsidePlotArea ? a.push(c) : c.setLayout();
                    ...
                    for (B = 0; B < l.dataPoints.length; B++) {
                        ...
                        if (0 < B) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? ((v = e / l.dataPoints[B - 1].y), 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v))
                                    : ((v = e - l.dataPoints[B - 1].y), 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v)));
                        }
                        if (b < q && !h) null !== e && (r = b);
                        else {
                            if (!h && ((h = !0), 0 < B)) {
                    ...
                    for (q = 0; q < r.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((x = e / r.dataPoints[q - 1].y), 1 > x && (x = 1 / x), d.minDiff > x && 1 !== x && (d.minDiff = x))
                                    : ((x = e - r.dataPoints[q - 1].y), 0 > x && (x *= -1), d.minDiff > x && 0 !== x && (d.minDiff = x)));
                        }
                        if (b < m && !g) null !== r.dataPoints[q].y && (k = b);
                            ...
                            null === r.dataPoints[q].y
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), 0 <= e ? (p[b] ? (p[b] += e) : ((p[b] = e), (B = Math.min(e, B)))) : l[b] ? (l[b] += e) : ((l[b] = e), (h = Math.max(e, h))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                        ...
                        (d.dataPointYPositiveSums
                            ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, p), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l))
                            : ((d.dataPointYPositiveSums = p), (d.dataPointYNegativeSums = l)));
                    ...
                    for (r = 0; r < n.dataPoints.length; r++) {
                        ...
                        if (0 < r) {
                            ...
                            s(e) ||
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((t = e / n.dataPoints[r - 1].y), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e - n.dataPoints[r - 1].y), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
                        }
                        if (b < k && !q) null !== e && (v = b);
                        else {
                            if (!q && ((q = !0), 0 < r)) {
                            ...
                            null === e
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), 0 <= e ? (p = !0) : 0 > e && (l = !0), (B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e)));
                        }
                    }
                ...
                a.axisY.logarithmic
                    ...
                    : p && !l
                        ...
                        : p && l
                            ...
                            : !p && l && ((d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = B;
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    for (n = 0; n < h.dataPoints.length; n++) {
                        ...
                        0 < n &&
                            (a.axisX.logarithmic
                                ? ((v = b / h.dataPoints[n - 1].x), 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff = v))
                                : ((v = b - h.dataPoints[n - 1].x), 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)),
                                e &&
                                null !== e[0] &&
                                h.dataPoints[n - 1].y &&
                                null !== h.dataPoints[n - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((v = e[0] / h.dataPoints[n - 1].y[0]), 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v))
                                    : ((v = e[0] - h.dataPoints[n - 1].y[0]), 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v))));
                        if (!(b < m) || r) {
                            if (!r && ((r = !0), 0 < n)) {
                                n -= 2;
                                g = k;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if ((l.dataPoints[B].x && l.dataPoints[B].x.getTime) || "dateTime" === l.xValueType) f = !0;
                    for (B = 0; B < l.dataPoints.length; B++)
                        "undefined" !== typeof l.dataPoints[B].isCumulativeSum && !0 === l.dataPoints[B].isCumulativeSum
                            ? ((l.dataPointEOs[B].cumulativeSumYStartValue = 0), (l.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum), (l.dataPoints[B].y = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum))
                            : "undefined" !== typeof l.dataPoints[B].isIntermediateSum && !0 === l.dataPoints[B].isIntermediateSum
                                ? ((l.dataPointEOs[B].cumulativeSumYStartValue = r),
                                    (l.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                                    (l.dataPoints[B].y = 0 === B ? 0 : b),
                                    (r = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                                    (b = 0))
                                : ((e = "number" !== typeof l.dataPoints[B].y ? 0 : l.dataPoints[B].y),
                                    (l.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum),
                                    (l.dataPointEOs[B].cumulativeSum = 0 === B ? e : l.dataPointEOs[B - 1].cumulativeSum + e),
                                    (b += e));
                    for (B = 0; B < l.dataPoints.length; B++)
                        if (
                            ("undefined" === typeof l.dataPoints[B].x && (l.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)),
                                ...
                                b < c.min && (c.min = b),
                                b > c.max && (c.max = b),
                                l.dataPointEOs[B].cumulativeSum < d.min && (d.min = l.dataPointEOs[B].cumulativeSum),
                                l.dataPointEOs[B].cumulativeSum > d.max && (d.max = l.dataPointEOs[B].cumulativeSum),
                                0 < B &&
                                (a.axisX.logarithmic
                                    ? ((r = b / l.dataPoints[B - 1].x), 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r))
                                    : ((r = b - l.dataPoints[B - 1].x), 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)),
                                    null !== e &&
                                    null !== l.dataPoints[B - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = l.dataPointEOs[B].cumulativeSum / l.dataPointEOs[B - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = l.dataPointEOs[B].cumulativeSum - l.dataPointEOs[B - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                                !(b < q) || h)
                        ) {
                            if (!h && ((h = !0), 0 < B)) {
                                B -= 2;
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < B &&
                                (l.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[B - 1].cumulativeSum),
                                    l.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = l.dataPointEOs[B - 1].cumulativeSum));
        ...
        m.prototype.calculateAutoBreaks = function () {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, r = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
                            ...
                            if (!(4 > k.dataPoints.length))
                                for (r = 0; r < k.dataPoints.length; r++)
                                    if (
                                        (b &&
                                            ((q = ((p + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                                        ...
                                        if ((g = "waterfall" === a.type ? k.dataPointEOs[r].cumulativeSum : k.dataPoints[r].y) && g.length)
                                            for (var u = 0; u < g.length; u++) (q = Math.floor((g[u] - l) / m)), g[u] < d[q].min && (d[q].min = g[u]), g[u] > d[q].max && (d[q].max = g[u]);
            ...
            for (var b, e = this, f = !1, p = 0; p < this._axes.length; p++)
                if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10); l++) this._axes[p].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity });
                }
            if (f) {
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        if (this._axes[p].dataInfo.dataPointYNegativeSums) {
                            ...
                            n = h;
                            for (l in q) q.hasOwnProperty(l) && !isNaN(l) && ((r = -1 * q[l]), s(r) || ((g = Math.floor((r - B) / b)), r < n[g].min && (n[g].min = r), r > n[g].max && (n[g].max = r)));
                        ...
                        if (this._axes[p].scaleBreaks.customBreaks)
                            for (l = 0; l < this._axes[p].scaleBreaks.customBreaks.length; l++)
                                for (b = 0; b < f.length; b++)
                                    if (
                                        (this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue) ||
                                        (this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue) ||
                                        (f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].startValue && this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].end) ||
                                        (f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue && this._axes[p].scaleBreaks.customBreaks[l].endValue <= f[b].end)
                                    )
                                        f.splice(b, 1), b--;
                        f.sort(function (a, b) {
            ...
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                    ...
                    (a.preventManipulation && a.preventManipulation(),
                        ...
                        Ea && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")),
                        !e)
                ) {
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        this.validateRegion(b, l, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid &&
            ...
            for (p = 0; p < h.length; p++) {
                ...
                if (q > g)
                    var v = g,
                        g = q,
                        q = v;
                if (r.scaleBreaks) for (v = 0; !f && v < r.scaleBreaks._appliedBreaks.length; v++) f = r.scaleBreaks._appliedBreaks[v].startValue <= q && r.scaleBreaks._appliedBreaks[v].endValue >= g;
                if (isFinite(r.dataInfo.minDiff))
                    if (
                        ((v = r.getApparentDifference(q, g, null, !0)),
                            !(
                                f ||
                                (!(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && ((r.logarithmic && v < Math.pow(r.dataInfo.minDiff, 3)) || (!r.logarithmic && v < 3 * Math.abs(r.dataInfo.minDiff)))) ||
                                q < r.minimum ||
                                g > r.maximum
                            ))
                    )
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== F && "" !== F) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== t
                            ? ((e = c.y1),
                                (f = c.y2),
                                0 < C
                                    ? ((q = h.point.y - B - p - b), q < e && ((q = "auto" === t ? Math.max(h.point.y, e) + p + b : e + p + b), (w = q + B > h.point.y)))
                                    : ((q = h.point.y + p + b), q > f - B - p - b && ((q = "auto" === t ? Math.min(h.point.y, f) - B - p - b : f - B - p - b), (w = q < h.point.y))))
                            : ((e = Math.max(h.bounds.y1, c.y1)),
                                (f = Math.min(h.bounds.y2, c.y2)),
                                (b = 0 <= n.indexOf("range") || "error" === n ? (0 < C ? Math.max(h.bounds.y1, c.y1) + B / 2 + p : Math.min(h.bounds.y2, c.y2) - B / 2 - p) : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2),
                                0 < C
                                    ? ((q = Math.max(h.point.y, b) - B / 2), q < e && ("bubble" === n || "scatter" === n) && (q = Math.max(h.point.y - B - p, c.y1 + p)))
                                    : ((q = Math.min(h.point.y, b) - B / 2), q > f - B - p && ("bubble" === n || "scatter" === n) && (q = Math.min(h.point.y + p, c.y2 - B - p))),
                                (q = Math.min(q, f - B)));
                    } else
                        0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? ((t = "auto"), (e = 4)) : 0 <= n.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === n && (t = "inside"),
                            (q = h.point.y - B / 2),
                            "inside" !== t
                                ? ((p = c.x1),
                                    (f = c.x2),
                                    0 > C
                                        ? ((r = h.point.x - l - e - b), r < p && ((r = "auto" === t ? Math.max(h.point.x, p) + e + b : p + e + b), (w = r + l > h.point.x)))
                                        : ((r = h.point.x + e + b), r > f - l - e - b && ((r = "auto" === t ? Math.min(h.point.x, f) - l - e - b : f - l - e - b), (w = r < h.point.x))))
                                : ((p = Math.max(h.bounds.x1, c.x1)),
                                    Math.min(h.bounds.x2, c.x2),
                                    (b =
                                        0 <= n.indexOf("range") || "error" === n ? (0 > C ? Math.max(h.bounds.x1, c.x1) + l / 2 + e : Math.min(h.bounds.x2, c.x2) - l / 2 - e) : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2),
                    ...
                    m &&
                        "inside" !== t &&
                        ((0 > n.indexOf("bar") && ("error" !== n || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2) || !w) &&
                        ((0 > n.indexOf("column") && ("error" !== n || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2) || !w) &&
                        ((d.lineWidth = m),
                            ...
                            0 <= n.indexOf("bar") || ("error" === n && h.axisSwapped)
                                ? d.lineTo(r + (0 < h.direction ? 0 : l), q + ("horizontal" === x ? B : -B) / 2)
                                : 0 <= n.indexOf("column") || ("error" === n && !h.axisSwapped)
                                    ? d.lineTo(r + l / 2, q + ((0 < h.direction ? B : -B) + ("horizontal" === x ? B : -B)) / 2)
                                    : d.lineTo(r + l / 2, q + ((q < h.point.y ? B : -B) + ("horizontal" === x ? B : -B)) / 2),
                            d.stroke());
                }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) (h = this._indexLabels[a]), (g = ka("indexLabelBackgroundColor", h.dataPoint, h.dataSeries)), (h.dataSeries.indexLabelBackgroundColor = s(g) ? (u ? "transparent" : null) : g);
            return d;
        };
                            ...
                            if (((x = n[t].x.getTime ? n[t].x.getTime() : n[t].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))))
                                if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || C || m) && (c.stroke(), u && b.stroke()), (C = !0);
                                    ...
                                    m || C
                                        ? (!m && h.connectNullData
                                            ? (c.setLineDash &&
                                                (h.options.nullDataLineDashType || (r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                                                (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), (r = h.nullDataLineDashType), c.setLineDash(q)),
                                                c.lineTo(x, s),
                                                u && b.lineTo(x, s))
                                    ...
                                    p = { x: x, y: s };
                                    t < n.length - 1 &&
                                        (k !== (n[t].lineColor || v) || r !== (n[t].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                            c.beginPath(),
                                            c.moveTo(x, s),
                                            (k = n[t].lineColor || v),
                                            (c.strokeStyle = k),
                                            c.setLineDash && (n[t].lineDashType ? ((r = n[t].lineDashType), c.setLineDash(N(r, h.lineThickness))) : ((r = h.lineDashType), c.setLineDash(g))));
                                    if (0 < n[t].markerSize || 0 < h.markerSize) {
                                        var z = h.getMarkerProperties(t, x, s, c);
                                        f.push(z);
                                        A = P(A);
                                        u && f.push({ x: x, y: s, ctx: b, type: z.type, size: z.size, color: A, borderColor: A, borderThickness: z.borderThickness });
                                    }
                                    (n[t].indexLabel || h.indexLabel || n[t].indexLabelFormatter || h.indexLabelFormatter) &&
                        ...
                        for (var C = !1, t = 0; t < n.length; t++)
                            if (((x = n[t].getTime ? n[t].x.getTime() : n[t].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))))
                                if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || C || m) && (c.stroke(), u && b.stroke()), (C = !0);
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: t, x1: x, y1: s };
                                    m || C
                                        ? (!m && h.connectNullData
                                            ? (c.setLineDash &&
                                                (h.options.nullDataLineDashType || (r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                                            ...
                                            : (c.beginPath(), c.moveTo(x, s), u && (b.beginPath(), b.moveTo(x, s))),
                                            (C = m = !1))
                                        : (c.lineTo(x, A), u && b.lineTo(x, A), c.lineTo(x, s), u && b.lineTo(x, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), u && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    p = { x: x, y: s };
                                    t < n.length - 1 &&
                                        (k !== (n[t].lineColor || v) || r !== (n[t].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                            ...
                                            c.setLineDash && (n[t].lineDashType ? ((r = n[t].lineDashType), c.setLineDash(N(r, h.lineThickness))) : ((r = h.lineDashType), c.setLineDash(g))));
                                    if (0 < n[t].markerSize || 0 < h.markerSize)
                                        (A = h.getMarkerProperties(t, x, s, c)), f.push(A), (z = P(z)), u && f.push({ x: x, y: s, ctx: b, type: A.type, size: A.size, color: z, borderColor: z, borderThickness: A.borderThickness });
                                    (n[t].indexLabel || h.indexLabel || n[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: n[t], dataSeries: h, point: { x: x, y: s }, direction: 0 > n[t].y === a.axisY.reversed ? 1 : -1, color: v });
                                }
                        c.stroke();
                        u && b.stroke();
                    }
                            ...
                            if (((t = n[m].getTime ? n[m].x.getTime() : n[m].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))))
                                if ("number" !== typeof n[m].y)
                                    0 < m &&
                                        !x &&
                                        (h.connectNullData
                                            ? b.setLineDash && 0 < s.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = q), (r = h.nullDataLineDashType))
                                            : (d(s), (s = []))),
                                        (x = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: m, x1: t, y1: x };
                                    s[s.length] = { x: t, y: x };
                                    m < n.length - 1 &&
                                        (k !== (n[m].lineColor || v) || r !== (n[m].lineDashType || h.lineDashType)) &&
                                        ((k = n[m].lineColor || v),
                                            (s[s.length - 1].newStrokeStyle = k),
                                            b.setLineDash && (n[m].lineDashType ? ((r = n[m].lineDashType), (s[s.length - 1].newLineDashArray = N(r, h.lineThickness))) : ((r = h.lineDashType), (s[s.length - 1].newLineDashArray = g))));
                                    if (0 < n[m].markerSize || 0 < h.markerSize) {
                                        var A = h.getMarkerProperties(m, t, x, b);
                                        p.push(A);
                                        C = P(C);
                                        u && p.push({ x: t, y: x, ctx: e, type: A.type, size: A.size, color: C, borderColor: C, borderThickness: A.borderThickness });
                                    }
                                    (n[m].indexLabel || h.indexLabel || n[m].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: n[m], dataSeries: h, point: { x: t, y: x }, direction: 0 > n[m].y === a.axisY.reversed ? 1 : -1, color: v });
                                    x = !1;
                                }
                    d(s);
                }
        ...
        m.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                r = this.dataPointWidth = this.options.dataPointWidth
                    ? this.dataPointWidth
                    : (0.9 * ((e.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range))) / a.plotType.totalDataSeries)) << 0;
                            ...
                            if ((v[f].getTime ? (B = v[f].x.getTime()) : (B = v[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y)) {
                                ...
                                (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        dataPoint: v[f],
                                        dataSeries: g,
                                        point: { x: p + (m - p) / 2, y: 0 > v[f].y === a.axisY.reversed ? l : t },
                                        direction: 0 > v[f].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: p, y1: Math.min(l, t), x2: m, y2: Math.max(l, t) },
                                        color: b,
                                    });
                            }
                }
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                    (l[b] = t[h].y + (l[b] ? l[b] : 0)), 0 < l[b] && ((r = a.axisY.convertValueToPixel(l[b])), (A = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = r));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y)
                                    (B[b] = t[h].y + (B[b] ? B[b] : 0)), (A = a.axisY.convertValueToPixel(B[b])), (r = "undefined" !== typeof p[b] ? p[b] : q), (p[b] = A);
                                ...
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: s, y1: Math.min(r, A), x2: C, y2: Math.max(r, A) },
                                        color: b,
                                    });
                            }
                    }
                        ...
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y)) {
                                    ...
                                    (B[b] = r + ("undefined" !== typeof B[b] ? B[b] : 0)), (A = a.axisY.convertValueToPixel(B[b])), (r = p[b] ? p[b] : q), (p[b] = A);
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                var s = (r - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    ...
                                    A;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                    (l[b] = t[h].y + (l[b] ? l[b] : 0)), 0 < l[b] && ((A = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(l[b])));
                                ...
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(A, n), y1: s, x2: Math.max(A, n), y2: C },
                                        color: b,
                                    });
                            }
                    }
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (B[b] = s + (B[b] ? B[b] : 0)), (n = p[b] ? p[b] : q), (p[b] = s = a.axisY.convertValueToPixel(B[b]));
                                ...
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(s, n), y1: C, x2: Math.max(s, n), y2: A },
                                        color: b,
                                    });
                            }
                    }
            ...
            function b() {
                A &&
                    (0 < g.lineThickness && f.stroke(),
                        a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (C = F) : 0 > a.axisY.viewportMaximum ? (C = l.y1) : 0 < a.axisY.viewportMinimum && (C = F),
                        f.lineTo(m, C),
                        f.lineTo(A.x, C),
                        f.closePath(),
                            ...
                            if (((s = v[k].x.getTime ? v[k].x.getTime() : v[k].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))))
                                if ("number" !== typeof v[k].y) g.connectNullData || ja || d || b(), (ja = !0);
                                    ...
                                    d || ja
                                        ? (!d && g.connectNullData
                                            ? (f.setLineDash &&
                                                ...
                                                ((d = m), (c = t), (m = n.x), (t = n.y), b(), f.moveTo(n.x, n.y), (m = d), (t = c), (A = n), (c = g.nullDataLineDashType), f.setLineDash(S)),
                                                f.lineTo(m, t),
                                                u && p.lineTo(m, t))
                                            : (f.beginPath(), f.moveTo(m, t), u && (p.beginPath(), p.moveTo(m, t)), (A = { x: m, y: t })),
                                            (ja = d = !1))
                                        : (f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b());
                                    n = { x: m, y: t };
                                    k < v.length - 1 &&
                                        (y !== (v[k].lineColor || w) || c !== (v[k].lineDashType || g.lineDashType)) &&
                                        (b(),
                                            (y = v[k].lineColor || w),
                                            (f.strokeStyle = y),
                                            f.setLineDash && (v[k].lineDashType ? ((c = v[k].lineDashType), f.setLineDash(N(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(R))));
                                    ...
                                    0 !== v[k].markerSize &&
                                        ...
                                        ((s = g.getMarkerProperties(k, m, t, f)), B.push(s), (Z = P(Z)), u && B.push({ x: m, y: t, ctx: p, type: s.type, size: s.size, color: Z, borderColor: Z, borderThickness: s.borderThickness }));
                                    (v[k].indexLabel || g.indexLabel || v[k].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: v[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > v[k].y === a.axisY.reversed ? 1 : -1, color: z });
                                }
                        b();
                        X.drawMarkers(B);
                    }
                            ...
                            if (((g = r[q].x.getTime ? r[q].x.getTime() : r[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !v)))))
                                if ("number" !== typeof r[q].y)
                                    0 < q &&
                                        !v &&
                                        (n.connectNullData
                                            ? b.setLineDash && 0 < s.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = y), (z = n.nullDataLineDashType))
                                            : (d(), (s = []))),
                                        (v = !0);
                                else {
                                    ...
                                    s[s.length] = { x: g, y: v };
                                    q < r.length - 1 &&
                                        (A !== (r[q].lineColor || C) || z !== (r[q].lineDashType || n.lineDashType)) &&
                                        ((A = r[q].lineColor || C),
                                            (s[s.length - 1].newStrokeStyle = A),
                                            b.setLineDash && (r[q].lineDashType ? ((z = r[q].lineDashType), (s[s.length - 1].newLineDashArray = N(z, n.lineThickness))) : ((z = n.lineDashType), (s[s.length - 1].newLineDashArray = D))));
                                    if (0 !== r[q].markerSize && (0 < r[q].markerSize || 0 < n.markerSize)) {
                                        var R = n.getMarkerProperties(q, g, v, b);
                                        p.push(R);
                                        S = P(S);
                                        u && p.push({ x: g, y: v, ctx: e, type: R.type, size: R.size, color: S, borderColor: S, borderThickness: R.borderThickness });
                                    }
                                    (r[q].indexLabel || n.indexLabel || r[q].indexLabelFormatter || n.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: r[q], dataSeries: n, point: { x: g, y: v }, direction: 0 > r[q].y === a.axisY.reversed ? 1 : -1, color: F });
                                    v = !1;
                                }
                        d();
                        X.drawMarkers(p);
                                        ...
                                        d || c
                                            ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                    ...
                                                    ((d = m), (c = t), (m = n.x), (t = n.y), b(), f.moveTo(n.x, n.y), (m = d), (t = c), (A = n), (S = g.nullDataLineDashType), f.setLineDash(R)),
                                                    f.lineTo(m, Z),
                                                    f.lineTo(m, t),
                                                    u && (p.lineTo(m, Z), p.lineTo(m, t)))
                                                : (f.beginPath(), f.moveTo(m, t), u && (p.beginPath(), p.moveTo(m, t)), (A = { x: m, y: t })),
                                                (c = d = !1))
                                            : (f.lineTo(m, Z), u && p.lineTo(m, Z), f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b()),
                                        (n = { x: m, y: t }),
                                        k < v.length - 1 &&
                                        (y !== (v[k].lineColor || w) || S !== (v[k].lineDashType || g.lineDashType)) &&
                                        (b(),
                                            (y = v[k].lineColor || w),
                                            (f.strokeStyle = y),
                                            f.setLineDash && (v[k].lineDashType ? ((S = v[k].lineDashType), f.setLineDash(N(S, g.lineThickness))) : ((S = g.lineDashType), f.setLineDash(D)))),
                                        (s = g.dataPointIds[k]),
                                        (this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t }),
                                        0 !== v[k].markerSize &&
                                        (0 < v[k].markerSize || 0 < g.markerSize) &&
                                        ((Z = g.getMarkerProperties(k, m, t, f)), B.push(Z), (s = P(s)), u && B.push({ x: m, y: t, ctx: p, type: Z.type, size: Z.size, color: s, borderColor: s, borderThickness: Z.borderThickness })),
                                        (v[k].indexLabel || g.indexLabel || v[k].indexLabelFormatter || g.indexLabelFormatter) &&
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Z))))
                                if ("number" !== typeof fa.y) z.connectNullData || Z || x || d(), (Z = !0);
                                    ...
                                    x || Z
                                        ? (!x && z.connectNullData
                                            ? (b.setLineDash &&
                                                (z.options.nullDataLineDashType || (F === z.lineDashType && z.lineDashType !== z.nullDataLineDashType)) &&
                                                ((x = h.pop()), (F = h[h.length - 1]), d(), b.moveTo(t.x, t.y), h.push(F), h.push(x), (F = z.nullDataLineDashType), b.setLineDash(R)),
                                                b.lineTo(g, v),
                                                u && s.lineTo(g, v))
                                            : (b.beginPath(), b.moveTo(g, v), u && (s.beginPath(), s.moveTo(g, v))),
                                            (Z = x = !1))
                                        : (b.lineTo(g, v), u && s.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), u && s.moveTo(g, v), h.push({ x: g, y: m - la })));
                                    t = { x: g, y: v };
                                    q < w.length - 1 &&
                                        (S !== (w[q].lineColor || y) || F !== (w[q].lineDashType || z.lineDashType)) &&
                                        (d(),
                                            b.beginPath(),
                                            b.moveTo(g, v),
                                            h.push({ x: g, y: m - la }),
                                            (S = w[q].lineColor || y),
                                            (b.strokeStyle = S),
                                            b.setLineDash && (w[q].lineDashType ? ((F = w[q].lineDashType), b.setLineDash(N(F, z.lineThickness))) : ((F = z.lineDashType), b.setLineDash(D))));
                                    ...
                                    0 <= z.dataPointIndexes[f] &&
                                        ...
                                        ((la = z.getMarkerProperties(z.dataPointIndexes[f], g, v, b)),
                                            p.push(la),
                                            (f = P(E)),
                                            u && p.push({ x: g, y: v, ctx: s, type: la.type, size: la.size, color: f, borderColor: f, borderThickness: la.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: z, point: { x: g, y: v }, direction: 0 > w[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, v);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var A = a.dataSeriesIndexes[w],
                        ...
                        y = z.dataPoints;
                    z.dataPointIndexes = [];
                    for (q = 0; q < y.length; q++) (A = y[q].x.getTime ? y[q].x.getTime() : y[q].x), (z.dataPointIndexes[A] = q), e[A] || (n.push(A), (e[A] = !0));
                    n.sort(Na);
                }
                for (w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Z))))
                                if ("number" !== typeof fa.y) z.connectNullData || Z || s || d(), (Z = !0);
                                else {
                                    var la;
                                    ...
                                    s || Z
                                        ? (!s && z.connectNullData
                                            ? (b.setLineDash &&
                                                ...
                                                ((s = h.pop()), (t = h[h.length - 1]), d(), b.moveTo(m.x, m.y), h.push(t), h.push(s), (t = z.nullDataLineDashType), b.setLineDash(R)),
                                                b.lineTo(g, v),
                                                u && F.lineTo(g, v))
                                            : (b.beginPath(), b.moveTo(g, v), u && (F.beginPath(), F.moveTo(g, v))),
                                            (Z = s = !1))
                                        : (b.lineTo(g, v), u && F.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), u && F.moveTo(g, v), h.push({ x: g, y: x - ba })));
                                    m = { x: g, y: v };
                                    q < y.length - 1 &&
                                        ...
                                        (d(),
                                            ...
                                            (S = y[q].lineColor || D),
                                            (b.strokeStyle = S),
                                            b.setLineDash && (y[q].lineDashType ? ((t = y[q].lineDashType), b.setLineDash(N(t, z.lineThickness))) : ((t = z.lineDashType), b.setLineDash(E))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    0 <= z.dataPointIndexes[f] &&
                                        0 !== fa.markerSize &&
                                        (0 < fa.markerSize || 0 < z.markerSize) &&
                                        ((ba = z.getMarkerProperties(q, g, v, b)), l.push(ba), (f = P(G)), u && l.push({ x: g, y: v, ctx: F, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: z, point: { x: g, y: v }, direction: 0 > y[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, v);
                    ...
                    if (((n = a.dataSeriesIndexes[h]), (r = this.data[n]), (q = r.dataPoints), 0 < q.length))
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (((f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y)) {
                                ...
                                (q[e].indexLabel || r.indexLabel || q[e].indexLabelFormatter || r.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "bubble",
                                        dataPoint: q[e],
                                        dataSeries: r,
                    ...
                    if (0 < n.length) {
                        ...
                        for (var r = 0, q = 0, e = 0; e < n.length; e++)
                            if (((f = n[e].getTime ? (f = n[e].x.getTime()) : (f = n[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y)) {
                                ...
                                c.globalAlpha = 1;
                                (Math.sqrt((r - f) * (r - f) + (q - p) * (q - p)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ((r = h.dataPointIds[e]),
                                        (this._eventManager.objectMap[r] = { id: r, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: e, x1: f, y1: p }),
                                        (r = P(r)),
                            ...
                            if (
                                ...
                                "candlestick" === t.type
                                    ? (c.moveTo(k - y, n),
                                        ...
                                        c.lineTo(k - y, r),
                                        c.stroke(),
                                        ca(c, C, Math.min(h, q), A, Math.max(h, q), x[l].y[0] <= x[l].y[3] ? t.risingColor : f, z, e, F, F, !1, !1, t.fillOpacity),
                                        u &&
                                        ((e = P(D)),
                                            (b.strokeStyle = e),
                                            b.moveTo(k - y, n),
                                            ...
                                            b.lineTo(k - y, r),
                                            b.stroke(),
                                            ca(b, C, Math.min(h, q), A, Math.max(h, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === t.type &&
                                    (c.moveTo(k - y, n),
                                        c.lineTo(k - y, r),
                                        c.stroke(),
                                        ...
                                        ((e = P(D)),
                                            ...
                                            b.lineTo(A, q),
                                            b.stroke()));
                                (x[l].indexLabel || t.indexLabel || x[l].indexLabelFormatter || t.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: t.type,
                                        dataPoint: x[l],
                                        dataSeries: t,
                                        ...
                                        direction: 1,
                                        bounds: { x1: C, y1: Math.min(n, r), x2: A, y2: Math.max(n, r) },
                                        color: e,
                                    });
                            }
                }
                    ...
                    if (0 < F.length)
                        for (var C = 5 < v && x.bevelEnabled ? !0 : !1, p = 0; p < F.length; p++)
                            if (
                                ...
                                c.save();
                                0 < ba &&
                                    (c.beginPath(), (c.strokeStyle = la), (c.lineWidth = ba), c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(l - G, h), c.lineTo(l - G, k), c.stroke(), c.moveTo(l - G, r), c.lineTo(l - G, n), c.stroke());
                                c.restore();
                                ...
                                u &&
                                    ((e = P(O)),
                                        (b.strokeStyle = e),
                                        (b.lineWidth = ba),
                                        0 < ba && (b.moveTo(l - D - G, h), b.lineTo(l - D - G, Math.max(k, r)), b.stroke(), b.moveTo(l - D - G, Math.min(k, r)), b.lineTo(l - D - G, n), b.stroke()),
                                        ca(b, A, Math.max(h, n), z, Math.min(h, n), e, 0, null, !1, !1, !1, !1),
                                        0 < R && (b.beginPath(), (b.lineWidth = R), b.moveTo(l + Z / 2, r - fa), b.lineTo(l - Z / 2, r - fa), b.stroke(), b.moveTo(l + Z / 2, k + fa), b.lineTo(l - Z / 2, k + fa), b.stroke()));
                                (F[p].indexLabel || x.indexLabel || F[p].indexLabelFormatter || x.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: x.type,
                                        dataPoint: F[p],
                                        dataSeries: x,
                                        ...
                                        direction: 1,
                                        bounds: { x1: A, y1: Math.min(k, r), x2: z, y2: Math.max(k, r) },
                                        color: e,
                                    });
                            }
                }
                                ...
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: q,
                                            indexKeyword: 1,
                                            point: { x: m + (w - m) / 2, y: g[f].y[1] >= g[f].y[0] ? p : l },
                                            direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                                            bounds: { x1: m, y1: Math.min(p, l), x2: w, y2: Math.max(p, l) },
                                            color: b,
                                        });
                    ...
                    if (0 < A.length)
                        for (var E = C._colorSet, l = 0; l < A.length; l++) {
                            ...
                            if (!(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax) && !s(A[l].y) && A[l].y.length && "number" === typeof A[l].y[0] && "number" === typeof A[l].y[1]) {
                                ...
                                b ? (r = ja) : (g = ja);
                                b
                                    ? ((q = a.axisX.reversed ? (h + ((z ? w : 1) * t) / 2 - (z ? D - 1 : 0) * t) << 0 : (h - ((z ? w : 1) * t) / 2 + (z ? D - 1 : 0) * t) << 0), (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                                    : ((n = a.axisX.reversed ? (k + ((z ? w : 1) * t) / 2 - (z ? D - 1 : 0) * t) << 0 : (k - ((z ? w : 1) * t) / 2 + (z ? D - 1 : 0) * t) << 0), (r = a.axisX.reversed ? (n - t) << 0 : (n + t) << 0));
                                !b && q > g && ((ja = q), (q = g), (g = ja));
                                b && n > r && ((ja = n), (n = r), (r = ja));
                                ja = C.dataPointIds[l];
                                ...
                                if (A[l].indexLabel || C.indexLabel || A[l].indexLabelFormatter || C.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: A[l],
                                        dataSeries: C,
                                        indexKeyword: 0,
                                        point: { x: b ? (A[l].y[1] >= A[l].y[0] ? n : r) : n + (r - n) / 2, y: b ? q + (g - q) / 2 : A[l].y[1] >= A[l].y[0] ? g : q },
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: C,
                                            indexKeyword: 1,
                                            point: { x: b ? (A[l].y[1] >= A[l].y[0] ? r : n) : n + (r - n) / 2, y: b ? q + (g - q) / 2 : A[l].y[1] >= A[l].y[0] ? q : g },
                                            direction: A[l].y[1] >= A[l].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(n, r) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, r) : r, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                        ...
                        for (f = 0; f < v.length; f++)
                            if (
                                (v[f].getTime ? (h = v[f].x.getTime()) : (h = v[f].x),
                                    !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(v[f].y) && v[f].y.length && "number" === typeof v[f].y[0] && "number" === typeof v[f].y[1])
                            ) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: p, y1: k, x2: l, y2: w };
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, p, k, l, w, b, 0, null, !1, !1, !1, !1);
                                if (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "rangeBar",
                                        dataPoint: v[f],
                                        dataSeries: g,
                                        indexKeyword: 0,
                                        point: { x: v[f].y[1] >= v[f].y[0] ? p : l, y: k + (w - k) / 2 },
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: g,
                                            indexKeyword: 1,
                                            point: { x: v[f].y[1] >= v[f].y[0] ? l : p, y: k + (w - k) / 2 },
                                            direction: v[f].y[1] >= v[f].y[0] ? 1 : -1,
                                            bounds: { x1: Math.min(p, l), y1: k, x2: Math.max(p, l), y2: w },
                                            color: b,
                                        });
                            ...
                            if (((t = r[g].x.getTime ? r[g].x.getTime() : r[g].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))))
                                if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                                    ...
                                    q || S
                                        ? (n.connectNullData && !q
                                            ? (b.setLineDash &&
                                                ...
                                                ((k[k.length - 1].newLineDashArray = D), (z = n.nullDataLineDashType), b.setLineDash(y)),
                                                b.lineTo(v, m),
                                                u && e.lineTo(v, m),
                                                k.push({ x: v, y: s }))
                                            : (b.beginPath(), b.moveTo(v, m), (x = { x: v, y: m }), (k = []), k.push({ x: v, y: s }), u && (e.beginPath(), e.moveTo(v, m))),
                                            (S = q = !1))
                                        : (b.lineTo(v, m), k.push({ x: v, y: s }), u && e.lineTo(v, m), 0 == g % 250 && d());
                                    t = n.dataPointIds[g];
                                    this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: g, x1: v, y1: m, y2: s };
                                    g < r.length - 1 &&
                                        (A !== (r[g].lineColor || C) || z !== (r[g].lineDashType || n.lineDashType)) &&
                                        (d(),
                                            (A = r[g].lineColor || C),
                                            ...
                                            b.setLineDash &&
                                            (r[g].lineDashType
                                                ? ((z = r[g].lineDashType), (k[k.length - 1].newLineDashArray = N(z, n.lineThickness)), b.setLineDash(k[k.length - 1].newLineDashArray))
                                                : ((z = n.lineDashType), (k[k.length - 1].newLineDashArray = D), b.setLineDash(D))));
                                    ...
                                    if (r[g].indexLabel || n.indexLabel || r[g].indexLabelFormatter || n.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: r[g], dataSeries: n, indexKeyword: 0, point: { x: v, y: m }, direction: r[g].y[0] > r[g].y[1] === a.axisY.reversed ? -1 : 1, color: w }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: r[g],
                                                dataSeries: n,
                        ...
                        for (g = !1; r < n.length; r++)
                            if (((q = n[r].x.getTime ? n[r].x.getTime() : n[r].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))))
                                if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" === typeof n[r].y[1]) {
                                    ...
                                    y[y.length] = { x: q, y: m };
                                    r < n.length - 1 &&
                                        (F !== (n[r].lineColor || x) || C !== (n[r].lineDashType || h.lineDashType)) &&
                                        ((F = n[r].lineColor || x),
                                            (s[s.length - 1].newStrokeStyle = F),
                                            b.setLineDash && (n[r].lineDashType ? ((C = n[r].lineDashType), (s[s.length - 1].newLineDashArray = N(C, h.lineThickness))) : ((C = h.lineDashType), (s[s.length - 1].newLineDashArray = A))));
                                    ...
                                    if (n[r].indexLabel || h.indexLabel || n[r].indexLabelFormatter || h.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[r], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: n[r].y[0] <= n[r].y[1] ? -1 : 1, color: t }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[r], dataSeries: h, indexKeyword: 1, point: { x: q, y: m }, direction: n[r].y[0] <= n[r].y[1] ? 1 : -1, color: t });
                                    g = !1;
                                } else
                                    0 < r &&
                                        !g &&
                                        (h.connectNullData
                                            ? b.setLineDash && 0 < s.length && (h.options.nullDataLineDashType || !n[r - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = z), (C = h.nullDataLineDashType))
                                            : (d(A, x), (s = []), (y = []))),
                                        (g = !0);
                        d(A, x);
                        X.drawMarkers(f);
                        ...
                        for (var F = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, A = null, z = null, p = 0; p < w.length; p++)
                            if ((w[p].getTime ? (n = w[p].x.getTime()) : (n = w[p].x), "number" !== typeof w[p].y)) {
                                ...
                                var R,
                                    S = l;
                                R =
                                    ("undefined" !== typeof w[p].isIntermediateSum && !0 === w[p].isIntermediateSum) || ("undefined" !== typeof w[p].isCumulativeSum && !0 === w[p].isCumulativeSum)
                                        ? 0 < w[p].y
                                            ? k
                                            : h
                                        : 0 < w[p].y
                                ...
                                0 < p &&
                                    ...
                                    (C && c.setLineDash && c.setLineDash(N(y, t)),
                                        ...
                                        c.lineTo(S, R - x),
                                        0 < t && c.stroke(),
                                        u && (b.beginPath(), b.moveTo(A, z - x), b.lineTo(S, R - x), 0 < t && b.stroke()));
                                C = !1;
                                A = D;
                                z = 0 < w[p].y ? k : h;
                                ...
                                (w[p].indexLabel || s.indexLabel || w[p].indexLabelFormatter || s.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "waterfall",
                                        dataPoint: w[p],
                                        dataSeries: s,
        ...
        var Y = function (a, d, c, b, e, f, p, l, k) {
            if (!(0 > c)) {
                ...
                "pie" === e
                    ...
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, p, !1), 0 <= k && a.arc(d.x, d.y, k * c, p, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    var q = 0,
                        ...
                        r = (q = q = 0);
                    0 > c
                        ? k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 > l && k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + c < l && (c = -(l - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + c)))
                        : k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 < l && k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + c > p && (c = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + c - p);
                    ...
                    0 > c
                        ? ((p = "right" === k.hemisphere ? r : q),
                            ...
                            ((r = -c),
                                ...
                                c - r < m && ((l = -r), (p = f(p, l, d + 1)), +p.toFixed(x) > +l.toFixed(x) && (h = c > m ? -(c - m) : -(r - (p - l))))))
                        : 0 < c &&
                        ((p = "right" === k.hemisphere ? q : r),
                            ...
                            ((r = c),
                                ...
                                c - r < m && ((l = r), (p = f(p, l, d + 1)), +p.toFixed(x) < +l.toFixed(x) && (h = c > m ? c - m : r - (l - p)))));
                    h &&
                        ((d = k.indexLabelTextBlock.y + h),
                            (c = 0),
                            (c = "right" === k.hemisphere ? F.x + Math.sqrt(Math.pow(u, 2) - Math.pow(d - F.y, 2)) : F.x - Math.sqrt(Math.pow(u, 2) - Math.pow(d - F.y, 2))),
                            k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t
                                ? ((l = (a - 1 + g.length) % g.length),
                                    (l = g[l]),
                                    (a = g[(a + 1 + g.length) % g.length]),
                                    "left" === k.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x
                                        ? (c = l.indexLabelTextBlock.x - 15)
                                        : "right" === k.hemisphere && "left" === a.hemisphere && c < a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x + 15))
                                : k.midAngle > (3 * Math.PI) / 2 - t &&
                                k.midAngle < (3 * Math.PI) / 2 + t &&
                                ((l = (a - 1 + g.length) % g.length),
                                    (l = g[l]),
                                    (a = g[(a + 1 + g.length) % g.length]),
                                    "right" === k.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x
                                        ? (c = l.indexLabelTextBlock.x + 15)
                                        : "left" === k.hemisphere && "right" === a.hemisphere && c > a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x - 15)),
                            (k.indexLabelTextBlock.y = d),
                            (k.indexLabelTextBlock.x = c),
                            (k.indexLabelAngle = Math.atan2(k.indexLabelTextBlock.y - F.y, k.indexLabelTextBlock.x - F.x)));
                }
                return h;
            }
            function p() {
                ...
                for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                            ...
                            if (null !== A) {
                                ...
                                if (0 > y) {
                                    ...
                                    var C = -1 * (y - s),
                                        I = (J = 0);
                                    "right" === p.hemisphere
                                        ? ((J = f(a, s)), (C = -1 * (y - J)), (I = f(A, C)), +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +s.toFixed(x) && f(a, -(C - I)))
                                        : ((J = f(A, s)), (C = -1 * (y - J)), (I = f(a, C)), +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +s.toFixed(x) && f(A, -(C - I)));
                                }
                            }
                        }
                    ...
                    for (a = 0; a < n.length; a++)
                        if (((p = g[a]), (A = p.indexLabelTextBlock.measureText()), 0 !== A.height && 0 !== A.width))
                            (A = A = 0),
                                "right" === p.hemisphere ? ((A = q.x2 - (p.indexLabelTextBlock.x + p.indexLabelTextBlock.width + r)), (A *= -1)) : (A = q.x1 - (p.indexLabelTextBlock.x - p.indexLabelTextBlock.width - r)),
                                0 < A &&
                                (!l &&
                                    p.indexLabelText &&
                                    ((s = "right" === p.hemisphere ? q.x2 - p.indexLabelTextBlock.x : p.indexLabelTextBlock.x - q.x1),
                                        0.3 * p.indexLabelTextBlock.maxWidth > s ? (p.indexLabelText = "") : (p.indexLabelTextBlock.maxWidth = 0.85 * s),
                                        0.3 * p.indexLabelTextBlock.maxWidth < s && (p.indexLabelTextBlock.x -= "right" === p.hemisphere ? 2 : -2)),
                                    Math.abs(p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - F.y) < z || Math.abs(p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 - F.y) < z) &&
                                ((A /= Math.abs(Math.cos(p.indexLabelAngle))), 9 < A && (A *= 0.3), A > d && (d = A)),
                                (A = A = 0),
                                0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI
                                    ? ((A = q.y2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + 5)), (A *= -1))
                                    : (A = q.y1 - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - 5)),
                                0 < A &&
                                (!l && p.indexLabelText && ((s = 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, A * s) && f(a, 2 * s)),
                                    Math.abs(p.indexLabelTextBlock.x - F.x) < z && ((A /= Math.abs(Math.sin(p.indexLabelAngle))), 9 < A && (A *= 0.3), A > d && (d = A)));
        ...
        m.prototype.renderFunnel = function (a) {
                    ...
                    (a = (Math.abs(x[h].y) * f) / g),
                        p
                            ...
                            : ((n = aa * aa * b * b - 4 * Math.abs(aa) * a),
                                0 > n
                                    ? ((n = c), (p = ((b + n) * (e - l)) / 2), (a -= p), (k = e - l), (l += e - l), (k += 0 == n ? 0 : a / n), (l += a / n), (p = !0))
                                    : ((k = (Math.abs(aa) * b - Math.sqrt(n)) / 2),
                                        (n = b - (2 * k) / Math.abs(aa)),
                                        (l += k),
                                        l > e && ((l -= k), (n = c), (p = ((b + n) * (e - l)) / 2), (a -= p), (k = e - l), (l += e - l), (k += a / n), (l += a / n), (p = !0)),
                                        (b = n))),
                        d.push(k);
                return d;
            }
            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, v = [], B = [], w = { percent: null, total: null }, A = null, z = 0; z < x.length; z++)
                    ...
                    for (var z = 0, F = x.length - 1; z < x.length || 0 <= F; z++, F--) {
                        ...
                        "inside" === t.indexLabelPlacement &&
                            ((v[z] = z !== ca ? (t.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4) : O[z].x3 - O[z].x6),
                                20 > v[z] && ((v[z] = z !== ca ? (t.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1) : O[z].x2 - O[z].x1), (v[z] /= 2)));
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        (a = O[l]),
                            ...
                            t.reversed
                                ? (H[l].textBlock.y + H[l].height > T + C && (H[l].textBlock.y = T + C - H[l].height), H[l].textBlock.y < qa - C && (H[l].textBlock.y = qa - C))
                                : (H[l].textBlock.y < T - C && (H[l].textBlock.y = T - C), H[l].textBlock.y + H[l].height > qa + C && (H[l].textBlock.y = qa + C - H[l].height));
            }
            function f() {
                var a, b, c, d;
                    ...
                    for (var e = 0; e < O.length; e++)
                        0 == H[e].textBlock.text.length
                            ...
                            : ((a = O[e]),
                                ...
                                t.reversed
                                    ? (H[e].textBlock.y + H[e].height > T + C && (H[e].textBlock.y = T + C - H[e].height), H[e].textBlock.y < qa - C && (H[e].textBlock.y = qa - C))
                                    : (H[e].textBlock.y < T - C && (H[e].textBlock.y = T - C), H[e].textBlock.y + H[e].height > qa + C && (H[e].textBlock.y = qa + C - H[e].height)));
                else
                    ...
                    for (var l, p = 1; p < h; p++) {
                        ...
                        for (var n = H.length - 1; 0 <= n; n--)
                            !H[n].isDirty &&
                                ...
                                ((l = q(n)), !(l >= H.length - 1) && H[n].textBlock.y + H[n].height + da > H[l].textBlock.y && (H[n].textBlock.y = H[n].textBlock.y + H[n].height - e > e - H[n].textBlock.y ? e + 1 : e - H[n].height - 1));
                    }
                ...
                for (var d, e, f, g, h, p, k = 1, n = 0; n < 2 * k; n++) {
                    for (
                        ...
                        !(0 <= r(m) && r(m),
                            ...
                            (e = +g.y.toFixed(6)),
                            !f.isDirty && h && e + d + da > +p.y.toFixed(6) && ((d = g.y + d + da - p.y), (e = a(m, -d)), e < d && (0 < e && (d -= e), (e = a(q(m), d)), e != d)));
                        m--
                    );
                    b();
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, F = this.plotArea, C = 0.025 * F.width, A = 0.01 * F.width, z = 0, D = F.height - 2 * C, E = Math.min(F.width - 2 * A, 2.8 * F.height), I = !1, R = 0;
                    R < x.length;
                    R++
                )
                    if (
                        (!I && "undefined" !== typeof x[R].indexLabel && null !== x[R].indexLabel && 0 < x[R].indexLabel.toString().length && (I = !0),
                ...
                if (0 != t.length && t.dataPoints && t.visible && 0 !== x.length) {
                    ...
                    if (-1 !== R) {
                        if (t.reversed) for (E.push(U), G = R.length - 1; 0 < G; G--) (U += R[G]), E.push(U);
                        else for (G = 0; G < R.length; G++) (U += R[G]), E.push(U);
                        if (t.reversed) for (G = 0; G < R.length; G++) E[G] < va ? (a.push(K), A.push(X), (ca = G)) : (a.push((E[G] - T + aa * W) / aa), A.push((E[G] - T + ea * $) / ea));
                        else for (G = 0; G < R.length; G++) E[G] < va ? (a.push((E[G] - T + aa * W) / aa), A.push((E[G] - T + ea * $) / ea), (ca = G)) : (a.push(K), A.push(X));
                        for (G = 0; G < R.length - 1; G++)
                            (U = t.reversed ? (x[x.length - 1 - G].color ? x[x.length - 1 - G].color : t._colorSet[(x.length - 1 - G) % t._colorSet.length]) : x[G].color ? x[G].color : t._colorSet[G % t._colorSet.length]),
                                G === ca
                                    ? O.push({ x1: a[G], y1: E[G], x2: A[G], y2: E[G], x3: X, y3: va, x4: A[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1], x6: K, y6: va, id: G, height: E[G + 1] - E[G], color: U })
                                    : O.push({ x1: a[G], y1: E[G], x2: A[G], y2: E[G], x3: A[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: U });
                        var da = 2,
                            H = [],
                            ha = !1,
                            Y = [],
                        ...
                        if (I && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
                            p();
                            for (G = 0; G < x.length; G++) H[G].isDirty || ((a = H[G].textBlock.x + H[G].width), (a = (M - a) / 2), 0 == G && (z = a), z > a && (z = a));
                            for (G = 0; G < O.length; G++) (O[G].x1 += z), (O[G].x2 += z), (O[G].x3 += z), (O[G].x4 += z), O[G].x5 && ((O[G].x5 += z), (O[G].x6 += z)), (H[G].textBlock.x += z);
                        }
        ...
        E.prototype.setLayout = function () {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ...
                : "center" === this.verticalAlign &&
                ((this.orientation = "vertical"), (c = this.horizontalAlign), (f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width), (p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height));
                ...
                if (r.dataPoints && r.dataPoints.length)
                    if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                        var q = (r.legendMarkerType = r.legendMarkerType
                            ? r.legendMarkerType
                            : ("line" !== r.type && "stepLine" !== r.type && "spline" !== r.type && "scatter" !== r.type && "bubble" !== r.type) || !r.markerType
                                ...
                                g = y.legendText
                                    ...
                                    : r.legendText
                                        ...
                                        : this.itemTextFormatter
                                            ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: r, dataPoint: y })
                                            : y.name
                                                ? y.name
                                                : "DataPoint: " + (x + 1),
                    ...
                    if (!(0 >= p || "undefined" === typeof p || 0 >= w || "undefined" === typeof w)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (
                                !r ||
                                r.width +
                                Math.round(q.textBlock.width + u + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                                f
                            )
                                (r = { items: [], width: 0 }), h.push(r), (this.height += g), (g = 0);
                            ...
                            (q.textBlock = new ia(this.ctx, {
                                ...
                                q.textBlock.measureText(),
                                null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                                this.height < p - this.lineHeight ? ((r = { items: [], width: 0 }), h.push(r)) : ((r = h[x]), (x = (x + 1) % h.length)),
        ...
        I.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (((r = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d })), this.axisX.logarithmic))
                        ...
                        switch (this.type) {
                            ...
                            case "error":
                                a >= q.x1 &&
                                    ...
                                    d >= q.y1 &&
                                    d <= q.y2 &&
                                    (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), (l = !0));
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "doughnut":
                                ...
                                m < q.radius &&
                                    ...
                                    ((m = Math.atan2(d - s.y, a - s.x)),
                                        ...
                                        m > s && m < u && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (l = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                m = q.funnelSection;
                                d > m.y1 &&
                                    ...
                                    (m.y6
                                        ...
                                        a > f && a < m && (b.push({ dataPoint: g, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), (l = !0)));
                                break;
                            case "boxAndWhisker":
                                if (
                                    ...
                                    b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), (l = !0);
                                break;
                            case "candlestick":
                                if (
            ...
            if ("bottom" === this._position || "top" === this._position)
                (l =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ...
                        Math.log(this.range)
                        : (this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * Q[this.intervalType + "Duration"] * this.interval),
                ...
                (l =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ...
                        Math.log(this.range)
                        : (this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * Q[this.intervalType + "Duration"] * this.interval),
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ...
                                        this.labelWrap
                                            ...
                                            : s(this.options.labelMaxWidth)
                                                ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                                    (this.sessionVariables.labelMaxHeight = p),
                                                    (this.sessionVariables.labelMaxWidth = f),
                                                    d && (m.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = n)))
                                                : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                                                    (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                                    (this.sessionVariables.labelMaxHeight = p),
                                                    (this.sessionVariables.labelWrap = this.labelWrap));
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth))
                                                ...
                                                if (((b = (m.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                                                    b - 2 * f > r &&
                                                        ((r = b - 2 * f),
                                                            b >= 2 * f && b < 2.2 * f
                                                                ? ((this.sessionVariables.labelMaxWidth = f),
                                                    ...
                                                    w === c &&
                                                    ((0 === w && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > r) ||
                                                        (w === this._labels.length - 1 && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > r) ||
                                                        (0 < w && w < this._labels.length - 1 && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > r && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > r))
                                                )
                                                    (r = 0 === w ? q + this._labels[w + 1].textBlock.measureText().width - 2 * f : q + this._labels[w - 1].textBlock.measureText().width - 2 * f),
                                                        (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                                        (this.sessionVariables.labelWrap = !0),
                                                        (this.sessionVariables.labelAngle = -25),
                                                        (this.sessionVariables.labelMaxWidth = n);
                                    ...
                                    ((this.sessionVariables.labelAngle = this.labelAngle),
                                        ...
                                        (this.sessionVariables.labelMaxHeight = p = this.labelWrap
                                            ? (h - n * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
            ...
            if ("normal" === e) {
                for (var x = [], y = [], C = [], A = [], M = [], N = [], P = [], Q = []; 4 > u;) {
                    var G = 0,
                        ...
                        O = 0,
                        aa = 0;
                    if (c && 0 < c.length) for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (O += C[g]), (K += c[g] && !n.isNavigator ? c[g].margin : 0);
                    else C.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(C);
                    if (b && 0 < b.length) for (A = [], g = aa = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), (aa += A[g]), ($ += b[g] ? b[g].margin : 0);
                            ...
                            a[g] &&
                                ((a[g].lineCoordinates.x1 = p),
                                    ...
                                    ((l = h = 0),
                                        ...
                                        (w = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                    ...
                                    ((l = 0),
                                        0 < a[g].labelAngle
                                            ? D + t > k && (l += 0 < a[g].labelAngle ? D + t - k - aa : 0)
                                            : 0 > a[g].labelAngle
                                                ? z - w < p && z - w < a[g].viewportMinimum && (E = p - (K + a[g].tickLength + C + z - w + a[g].labelFontSize / 2))
                                                : 0 === a[g].labelAngle && (D + t > k && (l = D + t / 2 - k - aa), z - w < p && z - w < a[g].viewportMinimum && (E = p - K - a[g].tickLength - C - z + w / 2)),
                                        a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < l
                                            ? (k -= l)
                                            : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E
                                                ? (p += E)
                                                : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (p += E), 0 < l && (k -= l))),
                                    ...
                                    (a[g].bounds = { x1: p, y1: l, x2: k, y2: h - (U + e - x[g] - G), width: k - p, height: h - l })),
                                (G += x[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K)),
                                ...
                                (d[g].bounds = { x1: p, y1: l + (X + Y - y[g] - V), x2: k, y2: h, width: k - p, height: h - l }),
                                (V += y[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (K = n.isNavigator ? 0 : 10),
                                ...
                                ((p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                    ...
                                    (c[g].lineCoordinates = { x1: p - T, y1: l, x2: k - T, y2: h, height: Math.abs(h - l) }),
                                    ...
                                    (c[g].bounds = { x1: p - (C[g] + T), y1: l, x2: k, y2: h, width: k - p, height: h - l }),
                        ...
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ((p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2)),
                                    ...
                                    (h = Math.round(f.y2 - (U + e + K))),
                                    (b[g].lineCoordinates = { x1: p + W, y1: l, x2: p + W, y2: h, height: Math.abs(h - l) }),
                                    ...
                                    (b[g].bounds = { x1: p, y1: l, x2: k + (A[g] + W), y2: h, width: k - p, height: h - l }),
                            ...
                            a[g] &&
                                (a[g].calculateValueToPixelConversionParameters(),
                                    ...
                                    ((z =
                                        ...
                                        (D = a[g].logarithmic
                                            ? (1 < p ? (Math.log(p) / a[g].conversionParameters.lnLogarithmBase) * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1
                                            : (0 < p ? p * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)));
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            d[g].calculateValueToPixelConversionParameters(),
                                ...
                                ((z =
                                    ...
                                    (D = d[g].logarithmic
                                        ? (1 < p ? (Math.log(p) / d[g].conversionParameters.lnLogarithmBase) * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1
                                        : (0 < p ? p * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1));
                    for (g = 0; g < q.length; g++) "axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues());
                    if (0 < u) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) m = M[u - 1][g] === M[u][g] ? !0 : !1;
                        else m = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[u - 1][g] === N[u][g] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[u - 1][g] === P[u][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = Q[u - 1][g] === Q[u][g] ? !0 : !1;
                        else L = !0;
                    }
                    if (m && I && J && L) break;
                    u++;
                ...
                for (N = []; 4 > u;) {
                    ...
                    M.push(E);
                    if (d && 0 < d.length) for (w = [], g = U = 0; g < d.length; g++) w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (U += w[g]), (Y += d[g] ? d[g].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                ...
                                c[g].labelAutoFit &&
                                !s(x) &&
                                (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ? Math.max(p, x / 2) : p),
                                    0 < !d.length && (k = 0 < c[g].labelAngle ? k - y / 2 : 0 === c[g].labelAngle ? k - y / 2 : k)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                ...
                                b[g] && b[g].labelAutoFit && !s(C) && (0 < !a.length && (p = 0 < b[g].labelAngle ? Math.max(p, C) : 0 === b[g].labelAngle ? Math.max(p, C / 2) : p), 0 < !d.length && (k -= A / 2)),
                    ...
                    if (c && 0 < c.length) for (r = [], g = T = 0; g < c.length; g++) r.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (T += r[g] + c[g].margin), (K += c[g].margin);
                    else r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    D.push(r);
                    if (b && 0 < b.length) for (z = [], g = V = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (V += z[g]), ($ += b[g].margin);
                        ...
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                ((h = b[g]._labels[0]),
                                    ...
                                    (A = l.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle))));
                    if (n.panEnabled) for (g = 0; g < c.length; g++) r[g] = s(n.sessionVariables.axisY.height) ? (n.sessionVariables.axisY.height = r[g]) : n.sessionVariables.axisY.height;
                    else for (g = 0; g < c.length; g++) n.sessionVariables.axisY.height = r[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (l = Math.round(f.y2)),
                                ...
                                "inside" === c[g].labelPlacement &&
                                0 < g &&
                                ((c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + r[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                                    (c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2)),
                                (c[g].bounds = { x1: p, y1: l - (r[g] + X + c[g].margin), x2: k, y2: h - (X + c[g].margin), width: k - p, height: r[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (X += r[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ((l = Math.round(f.y1)),
                                    ...
                                    "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - z[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                                    (b[g].bounds = { x1: p, y1: l + (b[g].margin + G), x2: k, y2: h, width: k - p, height: V }),
                                    b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                                    (G += z[g] + b[g].margin));
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            h =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2 - T)
        ...
        D.prototype.calculateBreaksSizeInValues = function () {
            for (
                ...
                (e = b || !s(d[f].options.spacing)),
                    (d[f].spacing = Pa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
        ...
        D.prototype.renderLabelsTicksAndTitle = function () {
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, l = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                            ...
                            r.position > this.viewportMaximum ||
                                !(h === this._labels.length - 1 || k < (Math.log(l / r.position) * m) / e) ||
                                (c.push(r), (l = r.position), (k = r.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = c;
                    } else {
                        for (h = 0; h < this._labels.length; h++)
                            (r = this._labels[h]),
                                r.position < this.viewportMinimum || ((k = r.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (c += k));
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], n, l = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                            ...
                            if (r.position < this.viewportMinimum) break;
                            r.position > this.viewportMaximum ||
                                !(h === this._labels.length - 1 || n < Math.log(l / r.position) * m) ||
                                (c.push(r), (l = r.position), (n = r.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = c;
                    } else {
                        for (h = 0; h < this._labels.length; h++)
                            (r = this._labels[h]),
                                r.position < this.viewportMinimum || ((n = r.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (b += n));
                                ...
                                ? ((q.x -= r.textBlock.width / 2),
                                    (q.y =
                                        "inside" === this.labelPlacement
                                            ? q.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + r.textBlock.height - r.textBlock.fontSize / 2)
                                            : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.fontSize / 2 + 5))
                                : ((q.x =
                                    "inside" === this.labelPlacement
                                        ? 0 > this.labelAngle
                                            ? q.x
                                            : q.x - r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                                        : q.x - (0 > this.labelAngle ? r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                                    (q.y =
                                        "inside" === this.labelPlacement
                                            ? 0 > this.labelAngle
                                                ? q.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5
                                                : q.y - ("inside" === this.tickPlacement ? 0 : this.tickLength) - Math.abs(r.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5)
                                            : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? r.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5 : 5))),
                                (r.textBlock.x = q.x),
                                (r.textBlock.y = q.y)));
                "inside" === this.tickPlacement &&
                                ...
                                ? ((q.x -= r.textBlock.width / 2),
                                    (q.y =
                                        "inside" === this.labelPlacement
                                            ...
                                            : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.height - r.textBlock.fontSize / 2)))
                                : ((q.x =
                                    "inside" === this.labelPlacement
                                        ? 0 < this.labelAngle
                                            ? q.x
                                            : q.x - r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                                        : q.x + (r.textBlock.height - this.labelFontSize) * Math.sin((Math.PI / 180) * this.labelAngle) - (0 < this.labelAngle ? r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                                    (q.y =
                                        "inside" === this.labelPlacement
                                            ? 0 < this.labelAngle
                                                ? q.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                                : q.y - r.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                            : q.y -
                                            (("inside" === this.tickPlacement ? 0 : this.tickLength) +
                                                ((r.textBlock.height - r.textBlock.fontSize / 2) * Math.cos((Math.PI / 180) * this.labelAngle) +
                                                    (0 < this.labelAngle ? r.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) : 0))))),
                                (r.textBlock.x = q.x),
                                (r.textBlock.y = q.y)));
                "inside" === this.tickPlacement &&
                    this.chart.addEventListener(
                                ...
                                ? ((r.textBlock.y = q.y),
                                    (r.textBlock.x =
                                        "inside" === this.labelPlacement
                                            ...
                                            : q.x - r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5))
                                : ((r.textBlock.y = "inside" === this.labelPlacement ? q.y : q.y - r.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                                    (r.textBlock.x =
                                        "inside" === this.labelPlacement
                                            ? q.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5
                                            : 0 < this.labelAngle
                                                ? q.x - r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5
                                                : q.x -
                                                r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) +
                                                (r.textBlock.height - r.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) -
                                                ("inside" === this.tickPlacement ? 0 : this.tickLength)))));
                "inside" === this.tickPlacement &&
                    this.chart.addEventListener(
                        "dataAnimationEnd",
                    ...
                    (r = this._labels[h]),
                        ...
                        ((q = this.getPixelCoordinatesOnAxis(r.position)),
                            ...
                            (0 === this.labelAngle
                                ? ((r.textBlock.y = q.y),
                                    (r.textBlock.x =
                                        "inside" === this.labelPlacement ? q.x - r.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5))
                                : ((r.textBlock.y =
                                    "inside" === this.labelPlacement
                                        ? q.y - r.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)
                                        : 0 > this.labelAngle
                                            ? q.y
                                            : q.y - (r.textBlock.height - r.textBlock.fontSize / 2 - 5) * Math.cos((Math.PI / 180) * this.labelAngle)),
                                    (r.textBlock.x =
                                        "inside" === this.labelPlacement
                                            ? q.x - r.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5
                                            : 0 < this.labelAngle
                                                ? q.x + (r.textBlock.height - r.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) + ("inside" === this.tickPlacement ? 0 : this.tickLength)
            ...
            else for (h = 0; h < this._labels.length; h++) (r = this._labels[h]), r.position < this.viewportMinimum || r.position > this.viewportMaximum || (d && 0 !== f++ % 2 && this.labelAutoFit) || r.textBlock.render(!0);
        };
                                ...
                                "bottom" === this._position
                                    ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.height - 3),
                                        ...
                                        a.x - c.textBlock.height > this.chart.plotArea.x1
                                            ...
                                            : ((c.textBlock.angle = 90), s(h.startValue) ? (a.x += c.textBlock.height - c.textBlock.fontSize / 2) : (a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3)),
                                        (a.y =
                                                                                                                                                                            ...
                                                                                                                                                                            : b / (2 * Q.monthDuration) <= a
                                                                                                                                                                                ...
                                                                                                                                                                                : b / (3 * Q.monthDuration) <= a
                                                                                                                                                                                    ...
                                                                                                                                                                                    : b / (6 * Q.monthDuration) <= a
                                                                                                                                                                                        ...
                                                                                                                                                                                        : ((this.interval = b / (1 * Q.yearDuration) <= a ? 1 : b / (2 * Q.yearDuration) <= a ? 2 : b / (4 * Q.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / Q.yearDuration)),
                ...
                if (null === this.minimum || null === this.maximum)
                    if (
                        ...
                        (this.intervalType = this.valueType = "number"),
                            ...
                            null === this.maximum &&
                            ((this.maximum = "axisX" === this.type ? f + k / 2 : Math.ceil(f / this.interval) * this.interval),
        ...
        D.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            if (this.scaleBreaks)
                for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
                    if (
                        ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue) ||
                            (!s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[k].startValue) ||
                            (!s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue)) &&
                        ((!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue) ||
                            (!s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[k].endValue) ||
                            (!s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue))
                    ) {
            ...
            "axisX" === this.type
                ? ((b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
                    ...
                    1 === e / b && ((k = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval)), (e *= k), (b /= k)),
                ...
                ((b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
                    ...
                    1 === b && 1 === e
                        ...
                        : 1 === e / b
                            ? ((k = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), (e *= k), (b /= k))
                            : b > e
                                ? ((k = Math.min((b / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), 1 <= e ? (b = e / k) : (e = b * k))
                                : ((k = Math.min((e / b) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= k), 1 !== b && (b /= k)),
                    (f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? (e / b) * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase),
            ...
            1 === this.viewportMaximum &&
                ...
                (1 === this.options.viewportMinimum ? (this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase) : 1 === this.options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase),
                    ...
                    ((this.interval = D.getNiceExponent(Math.ceil(Math.log(k) / d) / (a - 1))), (c = D.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
            if (null === this.minimum || null === this.maximum)
                "axisX" === this.type
                    ...
                    ((b = null !== this.minimum ? this.minimum : this.dataInfo.min),
                        ...
                        isFinite(b) || isFinite(e)
                            ? 1 === b && 1 === e
                                ...
                                : 1 === e / b
                                    ? ((k = Math.pow(this.logarithmBase, this.interval)), (e *= k), (b /= k))
                                    : b > e
                                        ? ((k = Math.min(0.01 * (b / e), 5)), 1 <= e ? (b = e / k) : (e = b * k))
                                        : ((k = Math.min((e / b) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= k), 1 !== b && (b /= k))
                    ...
                    if (
                        ((b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0),
                            ...
                            "top" === this.scaleBreaks.parent._position
                                ? ((e = this.chart.plotArea.y1), (l = (this.chart.plotArea.y2 + r / 2 + 0.5) << 0))
                                : ((e = this.chart.plotArea.y2), (l = (this.chart.plotArea.y1 - r / 2 + 0.5) << 0), (a *= -1)),
                    ...
                    if (
                        ((e = 1 === r % 2 ? (e.y << 0) + 0.5 : e.y << 0),
                            ...
                            "left" === this.scaleBreaks.parent._position
                                ? ((b = this.chart.plotArea.x1), (k = (this.chart.plotArea.x2 + r / 2 + 0.5) << 0))
                                : ((b = this.chart.plotArea.x2), (k = (this.chart.plotArea.x1 - r / 2 + 0.5) << 0), (a *= -1)),
        ...
        M.prototype.render = function () {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0), (k = this.chart.plotArea.y1), (l = this.chart.plotArea.y2), (this.bounds = { x1: e - d / 2, y1: k, x2: f + d / 2, y2: l });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (k = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0), (e = this.chart.plotArea.x1), (f = this.chart.plotArea.x2), (this.bounds = { x1: e, y1: k - d / 2, x2: f, y2: l + d / 2 });
                this.ctx.moveTo(e, k);
                this.ctx.lineTo(f, l);
                this.ctx.stroke();
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])), t = 0, v = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (var x = 0; x < n[v].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x]))), t < u && ((u = t), (w = v));
                        ...
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = (t = 0), v = (w = 0); v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x]))), t < u && ((u = t), (w = v));
                        ...
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = (y = t = 0), v = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x]))), t < u && ((u = t), (w = v));
                                ...
                                (y += n[v].dataPoint.y),
                                    (C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x),
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({ y: d }), u = null, w = 0; w < this.parent.dataSeries.length; w++)
                            ...
                            "dateTime" === this.parent.valueType
                                ? (h.text = this.labelFormatter
                                    ...
                                    : s(this.options.label)
                                        ? ya(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                        : this.label)
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({ x: a }), u = null, w = 0; w < this.parent.dataSeries.length; w++)
                                (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) &&
                                    0 <= u.index &&
                                    (h.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x })
                    ...
                    !s(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (v = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
                    for (w = 0; w < this.parent.dataSeries.length; w++)
                        (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && ((u.dataSeries = this.parent.dataSeries[w]), null !== u.dataPoint.y && u.dataSeries.visible && n.push(u));
                    if (0 === n.length) return;
                    n.sort(function (a, b) {
                    ...
                    if (
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), v = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) (t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x]))), t < u && ((u = t), (w = v));
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = C = y = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) (t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x]))), t < u && ((u = t), (w = v));
                            else
                                (y += n[v].dataPoint.y),
                                    (C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x),
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (k = this.chart.plotArea.y2), (this.bounds = { x1: b - r / 2, y1: f, x2: e + r / 2, y2: k });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (f = k = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - r / 2, x2: e, y2: k + r / 2 });
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        C = !1;
                        if (this.parent.labels)
                        ...
                        if (C) {
                            ...
                            "dateTime" === this.parent.valueType
                                ? (h.text = this.labelFormatter
                                    ...
                                    : s(this.options.label)
                                        ? ya(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo)
                                        : this.label)
                                : "number" === this.parent.valueType &&
                                (h.text = this.labelFormatter
                                    ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) })
                    ...
                    if (C) {
                        ...
                        "dateTime" === this.parent.valueType
                            ? (h.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) })
                                : s(this.options.label)
                                    ? ya(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                                    : this.label)
                            : "number" === this.parent.valueType &&
                            (h.text = this.labelFormatter
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var k = this.chart.axisX[m].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)
                        ...
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                for (k = this.chart.axisX[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)
                                    (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX[m].dataSeries[b]), null !== h.dataPoint.y && l.push(h));
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                for (k = this.chart.axisX2[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                                    (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX2[m].dataSeries[b]), null !== h.dataPoint.y && l.push(h));
                    }
                        ...
                        ("line" === b.type ||
                            ...
                            ? ((f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                                ...
                                ((f = b.getMarkerProperties(k, e.x1, e.y2, this.chart.overlaidCanvasCtx)),
                                    ...
                                    X.drawMarkers([f])))
                            : "bubble" === b.type
                                ? ((f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), X.drawMarkers([f]), (d.globalAlpha = 1))
                                : "column" === b.type ||
        ...
        $.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var k = 0; k < this.chart.data.length; k++) (c = this.chart.data[k]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !s(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
                    ...
                    if (c) {
                        ...
                        "circle" === b
                            ? (c.moveTo(a, d),
                                ...
                                f && c.fill(),
                                l && (k ? c.stroke() : ((m = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = m))))
                            : "square" === b
                                ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), l && (k ? c.stroke() : ((m = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = m))))
                                : "triangle" === b
                                    ? (c.beginPath(),
